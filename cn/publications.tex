...
\CS 通讯作者，\CF 共同一作
\begin{etaremune}
\item Zhang, Z.\CS, \SWei, Zhang, Y., \FWang, \Me\ (2026).
    Along-strike variations in sub-arc melting beneath the Alaska Peninsula revealed by P-wave attenuation.
    \emph{Journal of Geophysical Research: Solid Earth}, \emph{131}(8), e2026JB033769.
    \DOI{10.1029/2026JB033769}
\item
    \Me\CS, Fröhlich, Y., Leong, W. J., Grund, M., Schlitzer, W., Jones, M., Uieda, L., Luis, J. M. F. (2026).
    PyGMT: Bridging Python and the Generic Mapping Tools for Geospatial Visualization and Analysis.
    \emph{Geochemistry, Geophysics, Geosystems}, \emph{27}(7), e2026GC013105.
    \DOI{10.1029/e2026GC013105}
\item Li, H., Fu, L., Liu, Y., \Me, Sun, Y., Zhou, C., Hu, X. (2026).
...
\item Liu, X., \Me\CS\ (2026).
    Stress-drop variability in aftershocks of the 2018 Mw 7.9 Gulf of Alaska Outer-Rise Earthquake.
    \emph{Seismological Research Letters}.
    \DOI{10.1785/0220260048}
\item Wang, Z., Wang, D.\CS, Wan, Z., \Me\CS, Peng, Y. (2026).
    Decomposing earthquake moment tensors using P-wave first motion: Insights into
    global events with significant non-double-couple components.
    \emph{Geophysical Research Letters}, \emph{53}{7}, e2025GL121541.
    \DOI{10.1029/2025GL121541}
\item Zhang, Y. R.\CS, \SWei\CS, Byrnes, J. S., \Me, \FWang, Bezada, M. (2026).
    3D P-wave attenuation tomography of the Tonga-Lau subduction system with improved
    earthquake source parameters and a transdimensional Bayesian Markov Chain Monte Carlo approach.
    \emph{Journal of Geophysical Research: Solid Earth}, \emph{131}(4), e2025JB032176.
    \DOI{10.1029/2025JB032176}
\item Li, J.\CS, \Me, Chu, R. (2026).
    Ultralow velocity zones at the core-mantle boundary in the subduction regions
    consistent with the iron-rich origins revealed by ScP waveform complexities.
    \emph{Geophysical Journal International}, \emph{245}(1), ggag052.
    \DOI{10.1093/gji/ggag052}
